#!/bin/bash
# ===========================================================================
# Experiment 3: ESM-2 + GraphGPT Combined
# PCA-reduced ESM-2 embeddings (256-dim) + graph discrete features
...
WARMUP_EPOCHS=0.6
EMBED_DIM=256
OUTPUT_DIR="./exp/models/ogbl_ppa_human/esm2combined_pca256_h128_l2_b128_e6_lr3e-4"

echo "========================================"
echo "Experiment 3: ESM-2 + GraphGPT Combined"
echo "Model: tiny h=${HIDDEN} l=${LAYERS}"
echo "ESM-2: PCA 1280->256 (95.3% variance)"
echo "Coverage: 95.5%"
echo "Discrete node features: ENABLED (dim=2)"
